...
Create or update the correct planning artifact when work changes behavior, data shape, navigation, security boundaries, release risk, product scope, or shared package contracts. Use product briefs and PRDs for product-definition work, and feature specs plus implementation plans for delivery work. Tiny copy-only edits and isolated typo fixes can skip formal planning if they do not affect behavior or risk.
