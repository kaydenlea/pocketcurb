...
export function buildPrBody() {
  ...
  return [
    ...
    "- Applicable `docs/security/security-review-baseline.md` obligations: list each applicable item as addressed, deferred with rationale, or not applicable before merge.",
    "",
    "## Verification",
    "",
    "- [ ] lint",
